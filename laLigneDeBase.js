      ...
      if (settings.gutter == 0) {
        ...
        if (settings.demi) {// si demi le calcul se fait avec un gutter de moins, une col gutter de moins
          ...
          for (let i = 1; i<settings.column; i++) {
            ctx.fillRect(mDemi+settings.margin-(settings.gutter*.5)+Math.floor(i*largeurInt/settings.column), settings.margin, settings.gutter, hauteur - (settings.margin*2));
          }
        }
